...
FM_SEND_SETTLE=1        # CAP in seconds on fm-send's wait after a successful text submit; it returns as soon as the target reads busy, and waits the full cap when it never does; 0 disables
