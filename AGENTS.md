...
config/optional-tools  optional tools the captain has declined, one name per line; LOCAL, gitignored; an absent declined tool stops being reported missing, a non-declinable name is reported instead of honored; inherited by secondmate homes; see docs/configuration.md "Declined optional tools"
